...
<script type="text/javascript">
	...
	window.onload = function(){
		...
		var tdInnerHtmlList = ["이름","박성욱","별명","교수"];
		var tdCount = 0;
...
<body>
	...
	<div id='tableDiv'>
<!-- 		<table id='memberInfo' style="border: 1px solid black; border-collapse: collapse;"> -->
...
<!-- 		</table> -->
	...
	<button onclick="inputFnc();">날 누르면 테이블이 만들어져 </button>
