...
<script type="text/javascript">
	...
	var theText2 = "5images/img10.jpg";
	theText2 = theText2.split("/")[1];
	theText2 = theText2.substring(3);	//10.jpg
	theText2 = parseInt(theText2);		
	//parseInt: 글자를 숫자화시킴	
	//위 결과: 10 	단, 앞글자가 숫자이어야 뒤 글자들을 제거시키고
	//앞글자가 글자로 시작한다면 NaN 에러가 난다. (Not a number)
	document.write(theText2 + "<br />");

	document.write("<h3>마지막 문자 추출</h3>");
	var theText3 = "hello javascript";
	var lastIndex = theText3.length - 1;	//마지막 믹전 인덱스 
	theText3 = theText3.charAt(lastIndex);	
	document.write(theText3 + "<br />")
	
	document.write();
	var theText4 = "tel phone now home";
	var findIndex = theText4.indexOf("mobile");		//없으면 -1
	
	if(findIndex < 0){
		document.write("테스트에 맞는 문자가 없습니다.")
	}else{
		document.write("테스트에 맞는 문자가 포함되어 있습니다.");
	}
